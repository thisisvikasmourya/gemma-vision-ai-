...
from app.config import DEFAULT_LLM_MODEL, VIDEOS_DIR
...
def main():
    ...
    parser.add_argument("--interval", "-i", type=float, default=5.0, help="Keyframe interval in seconds")
    ...
    if args.video:
        ...
        pipeline = VideoUnderstandingPipeline(llm_model=args.model)
